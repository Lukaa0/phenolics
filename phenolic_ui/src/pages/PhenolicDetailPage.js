    ...
    <PageLayout>
      ...
      >
        <Grid item>
          ...
          <DataTable
            header={
              parentData.type === DATA_TYPES.SOURCE ? "Sources" : "Phenolics"
            }
            rows={parentData.values}
            navTo={
              parentData.type === DATA_TYPES.SOURCE
                ? NAV_LINKS.SOURCE_DETAIL
                : NAV_LINKS.PHENOLIC_DETAIL
            }
          />
        </Grid>
        <Grid item>
          ...
          <DataTable
            header={
              childrenData.type === DATA_TYPES.PHENOLIC
                ? "Phenolics"
                : "Molecules"
            }
